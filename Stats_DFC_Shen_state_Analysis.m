...
[CNT_meta, CNT_sync, CNT_dFC, CNT_dFC_cos, CNT_int, CNT_seg, CNT_CDC,CNT_matrix_CDC] = dynamicMetrics_2(CNT,2.5);
[ET_Pre_meta, ET_Pre_sync, ET_Pre_dFC, ET_Pre_dFC_cos, ET_Pre_int, ET_Pre_seg, ET_Pre_CDC,ET_Pre_matrix_CDC] = dynamicMetrics_2(ET_Pre,2.5);
[ET_Post_meta, ET_Post_sync, ET_Post_dFC, ET_Post_dFC_cos, ET_Post_int, ET_Post_seg, ET_Post_CDC,ET_Post_matrix_CDC] = dynamicMetrics_2(ET_Post,2.5);
...
%% whole brain mean FCD (recurent instantanious pase conectivity pattern)
...
[h,p] = ttest(mean(ET_Pre_CDC,2),mean(ET_Post_CDC,2))
